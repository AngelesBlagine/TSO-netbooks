...
const targetStr = `      <div class="card locked-card">
...
const newStr = `      <div class="card locked-card" style="margin-bottom: 1.5rem;">
          <div class="locked-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect>
                  <path d="M7 11V7a5 5 0 0 1 10 0v4"></path>
      ...
      <div class="card" style="margin-bottom: 2rem; border-left: 4px solid var(--primary);">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:0.5rem; margin-bottom: 1.5rem;">
          \${['G1','G2','G3','G4','G5','G6','G7','G8'].map(g => 
            \`<button class="btn btn-secondary" disabled style="width:auto; padding:0.5rem 1rem; opacity:0.6; cursor:not-allowed;">\${g}</button>\`
          ).join('')}
        </div>
...
ui = ui.replace(targetStr, newStr);
